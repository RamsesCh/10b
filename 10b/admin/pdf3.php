<?php
	...
	$pdf->Cell(180,20,utf8_decode('Resultados por grado académico '.$grado),1,1, 'C',1);
	...
	AND '$fecha_fin' AND U.Grado = '$grado' GROUP BY Estado";
	...
	WHERE D.Fecha BETWEEN '$fecha_inicio' AND '$fecha_fin' AND U.Grado = '$grado' GROUP BY Rango";
	...
	WHERE M.Fecha BETWEEN '$fecha_inicio' AND '$fecha_fin' AND U.Grado = '$grado' GROUP BY Cantidad_profunda";
	...
	WHERE E.Fecha BETWEEN '$fecha_inicio' AND '$fecha_fin' AND U.Grado = '$grado'";
	...
	WHERE C.Fecha BETWEEN '$fecha_inicio' AND '$fecha_fin' AND U.Grado = '$grado'";
