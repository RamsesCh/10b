...
<form method="POST" action="resultadosupdate2.php" name="formulario">
                    ...
                    <table id="example" class="table table-striped table-bordered tablaresultado" style="width:100%">
                        ...
                        <tbody>
                            <?php 
                                        ...
                                        INNER JOIN usuarios u ON u.Id_usuario = m.Id_usuario WHERE u.Id_usuario = '$id_usuario'";
                            ...
                            <tr>
                                <td>
                                    <input type="number" name="id_nuevo" readonly value="<?php echo $mostrar['Id_usuario']; ?>">
                                </td>
                                <td>
    ...
    <a href="resultados.php" class="boton_enviar" style="text-decoration:none">Regresar</a>
    </center>
</form>
